proc getPresetInfo {} {
  return [dict create name {ps7_base} description {ps7_base}  vlnv xilinx.com:ip:processing_system7:5.5 display_name {ps7_base} ]
}
