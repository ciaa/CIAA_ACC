# CIAA-ACC constraints for CIAA PS + PL Blinking leds sample project
# ----------------------------------------------------------------------------
...
set_property -dict {PACKAGE_PIN W14 IOSTANDARD LVCMOS25} [get_ports led_green_o]
set_property -dict {PACKAGE_PIN W17 IOSTANDARD LVCMOS25} [get_ports led_red_o]
