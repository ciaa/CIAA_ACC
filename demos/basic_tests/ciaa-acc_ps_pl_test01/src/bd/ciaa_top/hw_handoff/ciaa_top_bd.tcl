...
################################################################
# This is a generated script based on design: ciaa_top
#
...
# source ciaa_top_script.tcl


# The design that will be created by this Tcl script contains the following 
# module references:
# led_blink, test_axi_slv00, test_axi_slv01, plus_x, plus_x
...
proc create_root_design { parentCell } {
  ...
  set sysclk_n [ create_bd_port -dir I -from 0 -to 0 -type clk sysclk_n ]
  set sysclk_p [ create_bd_port -dir I -from 0 -to 0 -type clk sysclk_p ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_ACT_QSPI_PERIPHERAL_FREQMHZ {150.000000} \
   ...
   CONFIG.PCW_CAN_PERIPHERAL_DIVISOR0 {6} \
  ...
  # Create instance: test_axi_slv00_0, and set properties
  set block_name test_axi_slv00
  set block_cell_name test_axi_slv00_0
  if { [catch {set test_axi_slv00_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $test_axi_slv00_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: test_axi_slv01_0, and set properties
  set block_name test_axi_slv01
  set block_cell_name test_axi_slv01_0
  if { [catch {set test_axi_slv01_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $test_axi_slv01_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: u_plus_1, and set properties
  set block_name plus_x
  set block_cell_name u_plus_1
  if { [catch {set u_plus_1 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $u_plus_1 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
  ...
  # Create instance: u_plus_8, and set properties
  set block_name plus_x
  set block_cell_name u_plus_8
  if { [catch {set u_plus_8 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $u_plus_8 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins axi_interconnect_0/M00_AXI] [get_bd_intf_pins test_axi_slv00_0/S_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M01_AXI [get_bd_intf_pins axi_interconnect_0/M01_AXI] [get_bd_intf_pins test_axi_slv01_0/S_AXI]
  ...
  connect_bd_net -net ARESETN_1 [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins led_blink_0/arst1_sync_ni] [get_bd_pins ps_reset/interconnect_aresetn] [get_bd_pins test_axi_slv00_0/S_AXI_ARESETN] [get_bd_pins test_axi_slv01_0/S_AXI_ARESETN]
  connect_bd_net -net IBUF_DS_N_0_1 [get_bd_ports sysclk_n] [get_bd_pins util_ds_buf_0/IBUF_DS_N]
  connect_bd_net -net IBUF_DS_P_0_1 [get_bd_ports sysclk_p] [get_bd_pins util_ds_buf_0/IBUF_DS_P]
  connect_bd_net -net led_blink_0_led1_o [get_bd_ports led_green_o] [get_bd_pins led_blink_0/led1_o]
  connect_bd_net -net led_blink_0_led2_o [get_bd_ports led_red_o] [get_bd_pins led_blink_0/led2_o]
  connect_bd_net -net plus_x_0_user_plus_x_o [get_bd_pins test_axi_slv01_0/user_in_01_i] [get_bd_pins u_plus_1/user_plus_x_o]
  connect_bd_net -net plus_x_1_user_plus_x_o [get_bd_pins test_axi_slv01_0/user_in_02_i] [get_bd_pins u_plus_8/user_plus_x_o]
  connect_bd_net -net ps7_FCLK_CLK1 [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins led_blink_0/clk1_sync_i] [get_bd_pins ps7/FCLK_CLK1] [get_bd_pins ps7/M_AXI_GP0_ACLK] [get_bd_pins ps_reset/slowest_sync_clk] [get_bd_pins test_axi_slv00_0/S_AXI_ACLK] [get_bd_pins test_axi_slv01_0/S_AXI_ACLK]
  connect_bd_net -net ps7_FCLK_RESET1_N [get_bd_pins ps7/FCLK_RESET1_N] [get_bd_pins ps_reset/ext_reset_in]
  connect_bd_net -net test_axi_slv01_0_user_out_01_o [get_bd_pins test_axi_slv01_0/user_out_01_o] [get_bd_pins u_plus_1/user_number_i] [get_bd_pins u_plus_8/user_number_i]
  connect_bd_net -net test_axi_slv01_0_user_out_02_o [get_bd_pins led_blink_0/user_in_i] [get_bd_pins test_axi_slv01_0/user_out_02_o]
  connect_bd_net -net util_ds_buf_0_IBUF_OUT [get_bd_pins led_blink_0/clk2_async_i] [get_bd_pins util_ds_buf_0/IBUF_OUT]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces ps7/Data] [get_bd_addr_segs test_axi_slv00_0/S_AXI/reg0] SEG_test_axi_slv00_0_reg0
  create_bd_addr_seg -range 0x00010000 -offset 0x43C10000 [get_bd_addr_spaces ps7/Data] [get_bd_addr_segs test_axi_slv01_0/S_AXI/reg0] SEG_test_axi_slv01_0_reg0
