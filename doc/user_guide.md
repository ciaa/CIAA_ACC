...
![Vivado BDF](images/bdf.png)

## Resources

* [Board Design Repository](https://github.com/ciaa/Hardware/tree/master/PCB/ACC/CIAA_ACC)
* [Schematic](../hw/ciaa_acc_schematic.pdf)
* [Master Constraints File](../hw/ciaa_acc_master.xdc)
* [Board Definition Files](../support/bdf) for Vivado.
...
* Implemented as a USB-to-UART bridge with a LPC11U35 (U17). Instructions [here](../support/lpc) to change the default LPC11U35 firmware.
...
* My CIAA-ACC board appears as a mass storage device called **CRP DISABLD** when connected to J8.
  ...
  * If it is a new board, read [here](../support/lpc) to change the default LPC11U35 firmware.
