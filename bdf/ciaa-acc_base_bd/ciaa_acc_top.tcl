...
################################################################
# This is a generated script based on design: ciaa_acc_top
#
...
# source ciaa_acc_top_script.tcl
...
if { $list_projs eq "" } {
   ...
   set_property BOARD_PART ciaa project:ciaa-acc:part0:1.0 [current_project]
}
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net ARESETN_1 [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins ps_reset/interconnect_aresetn]
  connect_bd_net -net CLK_100M [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins ps7/FCLK_CLK1]
  connect_bd_net -net CLK_50M [get_bd_pins ps7/FCLK_CLK0] [get_bd_pins ps_reset/slowest_sync_clk]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins ps_reset/peripheral_aresetn]
